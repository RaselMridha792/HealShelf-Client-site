    ...
    <>
      <section className="my-20">
        ...
        <div className="grid lg:grid-cols-4 gap-10 md:grid-cols-2 grid-cols-1">
          <div className="border relative hover:shadow-lg duration-300">
          ...
          <div className="border relative hover:shadow-lg duration-300">
            ...
            <p className="absolute top-5 left-5">Migraine & Headache</p>
          </div>
          <div  className="border relative hover:shadow-lg duration-300">
            <img className="w-full h-52 object-cover" src={depression4} alt="" />
            <p className="absolute top-5 left-5">Stomach Pain</p>
          </div>
        </div>
      </section>
    </>
